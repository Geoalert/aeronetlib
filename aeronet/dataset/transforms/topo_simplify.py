...
def topo2geo(topo: topojson.Topology):
    ...
    transformer = Transformer(topo_dict['arcs'])
...
def simplify_as_topo(fc: FeatureCollection, geo_epsilon=0):
    """
    ...
    """
    topo_collection = topojson.Topology(geojson.FeatureCollection(fc.geojson),
                                        prequantize=False,
